...
window.__dialogsModule__ = {
  ...
  openProductDlg(row, S) {
    ...
    S.pForm = row
      ? { code: row.code || '', name: row.name || '',
          ...
          type: row.type || '面料', classification: row.classification || '定高',
          model: row.model || '', material: row.mat || '',
      ...
      : { code: '', name: '',
          ...
          categoryId: '', type: '面料', classification: '定高',
  ...
  async addProduct(S) {
    ...
    const payload = {
      ...
      product_type: f.type, classification: f.classification,
    ...
    try {
      ...
      S.products.push({
        ...
        type: d.product_type || '面料',
        classification: d.classification || '定高',
        model: d.model || '', mat: d.material || '',
